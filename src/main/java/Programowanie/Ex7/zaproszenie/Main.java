...
public class Main {
    ...
    public static int iloscZaproszen() {
        ...
        try {
            ...
            System.out.println(" Podano nieprawidłową wartość, proszę podać liczbę większą od 0");
    ...
    public static Zaproszenie[] pobierzInformacjeOGosciach() {
        ...
        for (int i = 0; i < liczbaZaproszen; i++) {
            ...
            while (!zaproszenie.equalsIgnoreCase("tak") && !zaproszenie.equalsIgnoreCase("nie")) {
                System.out.println("Podałeś nieprawidłową odpowiedź, proszę podać TAK lub NIE");
                zaproszenie = scanner.next();
            }
            ...
            System.out.println("Pomyśle dodano zaproszenie");
        }
